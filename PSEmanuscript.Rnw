...
<<groupings, echo=FALSE>>=
load('groupings.RData')
@
\begin{table}
Table 1
...
\\ \hline
Compassion & \Sexpr{group_matrix['compassion','compassion']} (\Sexpr{group_perc['compassion','compassion']*100}\%) & \Sexpr{group_matrix['compassion','sympathy']} (\Sexpr{group_perc['compassion','sympathy']*100}\%) & \Sexpr{group_matrix['compassion','empathy']} (\Sexpr{group_perc['compassion','empathy']*100}\%) & \Sexpr{group_matrix['compassion','pity']} (\Sexpr{group_perc['compassion','pity']*100}\%) & \Sexpr{group_matrix['compassion','tenderness']} (\Sexpr{group_perc['compassion','tenderness']*100}\%) \\
Sympathy & \Sexpr{group_matrix['sympathy','compassion']} (\Sexpr{group_perc['sympathy','compassion']*100}\%) & \Sexpr{group_matrix['sympathy','sympathy']} (\Sexpr{group_perc['sympathy','sympathy']*100}\%) & \Sexpr{group_matrix['sympathy','empathy']} (\Sexpr{group_perc['sympathy','empathy']*100}\%) & \Sexpr{group_matrix['sympathy','pity']} (\Sexpr{group_perc['sympathy','pity']*100}\%) & \Sexpr{group_matrix['sympathy','tenderness']} (\Sexpr{group_perc['sympathy','tenderness']*100}\%) \\
Empathy & \Sexpr{group_matrix['empathy','compassion']} (\Sexpr{group_perc['empathy','compassion']*100}\%) & \Sexpr{group_matrix['empathy','sympathy']} (\Sexpr{group_perc['empathy','sympathy']*100}\%) & \Sexpr{group_matrix['empathy','empathy']} (\Sexpr{group_perc['empathy','empathy']*100}\%) & \Sexpr{group_matrix['empathy','pity']} (\Sexpr{group_perc['empathy','pity']*100}\%) & \Sexpr{group_matrix['empathy','tenderness']} (\Sexpr{group_perc['empathy','tenderness']*100}\%) \\
Pity & \Sexpr{group_matrix['pity','compassion']} (\Sexpr{group_perc['pity','compassion']*100}\%) & \Sexpr{group_matrix['pity','sympathy']} (\Sexpr{group_perc['pity','sympathy']*100}\%) & \Sexpr{group_matrix['pity','empathy']} (\Sexpr{group_perc['pity','empathy']*100}\%) & \Sexpr{group_matrix['pity','pity']} (\Sexpr{group_perc['pity','pity']*100}\%) & \Sexpr{group_matrix['pity','tenderness']} (\Sexpr{group_perc['pity','tenderness']*100}\%) \\
Tenderness & \Sexpr{group_matrix['tenderness','compassion']} (\Sexpr{group_perc['tenderness','compassion']*100}\%) & \Sexpr{group_matrix['tenderness','sympathy']} (\Sexpr{group_perc['tenderness','sympathy']*100}\%) & \Sexpr{group_matrix['tenderness','empathy']} (\Sexpr{group_perc['tenderness','empathy']*100}\%) & \Sexpr{group_matrix['tenderness','pity']} (\Sexpr{group_perc['tenderness','pity']*100}\%) & \Sexpr{group_matrix['tenderness','tenderness']} (\Sexpr{group_perc['tenderness','tenderness']*100}\%) \\
\\ \hline
\end{tabular}
\end{table}
